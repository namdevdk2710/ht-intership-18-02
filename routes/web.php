...
Route::group(['prefix' => '/', 'namespace' => 'V1\Web\Frontend'], function () {
    ...
    Route::get('/register-donate', 'RequestBloodController@getRegisterDonated')->name('requestBlood.getRegisterDonated');
    Route::post('/register-donate/{calendarId}', 'RequestBloodController@postRegisterDonated')->name('requestBlood.postRegisterDonated');
});
//---------------------------Admin-Login----------------------------------------//
